...
class WeatherViewModel: ObservableObject {
    ...
    func fetchWeather() {
        guard let url = URL(string: "https://api.openweathermap.org/data/2.5/onecall?lat=35.6624938&lon=139.483652&units=metric&lang=ja&appid=563f1813695628294ea2117b80ed8826") else {
            return
        }
